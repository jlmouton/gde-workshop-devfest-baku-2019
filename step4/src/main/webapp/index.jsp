...
<!-- workshop hack: removing the loading spinner as we are disabling all the JS for this quick demo
...
<p class="mb-5">We will send you an invite for the Beta as soon as possible.</p>
<%
    } else {
%>
                <h1>Sign up for Awesome Stuff Beta</h1>
                <p class="mb-5">Please sign up below to receive updates as we progress toward the Beta of Awesome Stuff. As soon as we are adding new users in the Beta, you will receive an invitation at your email address</p>
                <form action="/" method="post">
                  <div class="form-group d-flex">
                    <input type="text" class="form-control" placeholder="Enter your email" name="email" />
                    <input type="submit" class="btn btn-primary text-white px-4" value="SIGN ME UP" />
                  </div>
                </form>
<% } %>
              </div>
...
<!-- workshop hack: removing all the other sections, as we only want our signup form 
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 ml-auto">
<!-- workshop hack: no need for a subscribe button here
            <div class="mb-5">
...
<!-- workshop hack: removing the JS as all we want is a decent looking HTML/CSS
